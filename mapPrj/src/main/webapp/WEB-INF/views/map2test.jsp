...
var positions=${item2};  //저장소에서   jsonArray 꺼내오기 EL문법으로 저장소에 저장된 값 꺼내기
...
for (var i = 0; i < positions.length; i ++) {
    ...
    let  newPosition  =   new kakao.maps.LatLng(position.la, position.lg);
    ...
    var marker = new kakao.maps.Marker({
        map: map, // 마커를 표시할 지도
        position: newPosition, // 마커를 표시할 위치
